...
export default function PlanetShowcaseSection() {
  return (
    <div className="flex flex-col items-center">
      ...
      >
        Lactarius-7, located in the heart of the Icy Nebula, is known for its
        creamy milk with a subtle, icy aftertaste. The inhabitants, called
        Lactonids, have perfected their craft over centuries, raising special
        cosmic cows on the planet&apos;s frozen plains.
      </PlanetShowcase>
      ...
      >
        Capriox-B is a world of endless mountain ranges, home to a resilient
        breed of cosmic goats known as Capriox. Their milk boasts an intense,
        rich flavor with subtle herbal notes, which the goats pick up while
        grazing in the high-altitude valleys.
      </PlanetShowcase>
      ...
      >
        ...
        been raising giant milkbeasts for generations—majestic animals with
        triple stomachs, allowing them to produce rich, velvety milk with a
